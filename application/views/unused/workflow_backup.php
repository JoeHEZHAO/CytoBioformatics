...
<body class="header-boxed">
	...
	<div id="main-container">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<p class="tp-caption text-center text">View a quick explanation of our services</p>
		...
		<div id="page-content">
            ...
            <div id="workflow-slideshow" class="container">
                <div id="workflow-slide-1">
                    <div class="text-center short-margin">
                        <h2>Say you are a pathologist...</h2>
                    </div>

                    <div class="col-lg-offset-1 text-block short-margin">
                ...
                <div id="workflow-slide-2">
                    <div class="text-center short-margin">
                        <h4>But you are also a researcher.</h4>
                    </div>
                ...
                <div id="workflow-slide-3">
                    <div class="text-center short-margin">
                        <h3>That's where <span class="text-alt-color">CytoInformatics</span> comes in.</h3>
                    </div>

                    <div class="col-lg-offset-1 text-block short-margin">
                        <p>Here at CytoInformatics, we aim to simplify the analysis of microscopy images for you while delivering pinpoint-accurate results.</p>

                        <p>To get started, follow these simple instructions.</p>
                    </div>
                </div>
                
                
                <div id="workflow-slide-4">
                    <div class="text-center short-margin">
                        <h4>Step 1: Submit a Quote</h4>
                    </div>

                    <div class="col-lg-offset-1 text-block short-margin">
                        <p>Click the <a href="<?php echo base_url('index.php/cyto_bioformatics/quote'); ?>">Quote</a> link at the top to access our quote submission form. You do not even need to register for an account to submit a quote. Just provide us with a brief description of the task you are looking to solve. We will contact you to discuss the problem you are looking to solve.</p> 

                        <p>You are also encouraged to submit up to three sample images so that we may better prepare to discuss with you.</p>
                    </div>
                </div>
            </div>
		</div><!-- PAGE CONTENT -->
