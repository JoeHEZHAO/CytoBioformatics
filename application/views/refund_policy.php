			...
			<div class="container">
				<div class="row">
					<div class="col-lg-offset-1 col-lg-5 col-sm-6" style="margin-top: 150px; margin-left: 8.333%; width: 81.333%;">
                        ...
                        <h6>1. Image(s) and Project refunds</h6>
                        <p>Client is eligible for and can request a full refund for individual Images or for a Project (excluding any applicable transaction fee(s)) if:</p>
                        <ol class="refund-ol" type="a">
                            <li>Client files a Refund Request;</li>
                            <li>Client can demonstrate that specific Project requirements have not been satisfied as defined in the initial Project Request;</li>
                            <li>Client has not yet electronically confirmed that Project deliverables have met the requirements as defined in the initial Project Request; and</li>
                            <li>Client files the Refund Request before Client receives the Project deliverables.</li>
                        </ol>
                        <h6>2. Exceptions</h6>
                        <p>Notwithstanding the terms above, Client is not eligible for and will not receive any refund if:</p>
                        <ol class="refund-ol" type="a">
                            <li>Client has already received Project deliverables; and</li>
                            <li>Client has electronically confirmed that Project deliverables have met the requirements as defined in the initial Project Request.</li>
                        </ol>
