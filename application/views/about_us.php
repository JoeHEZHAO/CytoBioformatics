...
<!--
            ...
            <section class="full-section dark-section">
                <div class="full-section-container">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="text-center text-default-color">Seeking customer service?</h2>
                                <h5 class="text-center">Contact us at: <a href="mailto:service@cytoinformatics.com">service@cytoinformatics.com</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script text="type/javascript">
        $(document).ready(function() {
            document.getElementById("about_us-button").setAttribute("class", "active");
        });
    </script>
